    ...
    <div class="card shadow-lg p-3">
        <form action="{{ route('position.update', $position) }}" method="post" class="form">
            ...
            <div class="mb-3">
                ...
                <input class="form-control rupiah-input @error('min_salary') is-invalid @enderror" type="text" id="min_salary"
                    name="min_salary" required value="{{ old('min_salary', round($position->min_salary)) }}">
            ...
            <div class="mb-3">
                ...
                <input class="form-control rupiah-input @error('max_salary') is-invalid @enderror" type="text" id="max_salary"
                    name="max_salary" required value="{{ old('max_salary', round($position->max_salary)) }}">
