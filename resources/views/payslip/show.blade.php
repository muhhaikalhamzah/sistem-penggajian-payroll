                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="d-flex justify-content-between mb-1 text-muted small">
                                <span>Potongan Dasar (Master)</span>
                                <span>Rp {{ number_format($payslip->employee->deductions->sum('amount'), 0, ',', '.') }}</span>
                            </div>
                            <div class="d-flex justify-content-between mb-1 text-muted small">
                                <span>Potongan Alpha ({{ $alphaCount }} Hari)</span>
                                <span>Rp {{ number_format($alphaDeduction, 0, ',', '.') }}</span>
                            </div>
                            <div class="d-flex justify-content-between mb-2 text-muted small">
                                <span>Pajak PPh 21</span>
                                <span>Rp {{ number_format($taxRecord->pph21_amount ?? 0, 0, ',', '.') }}</span>
                            </div>
                            <hr class="my-1">
                            <div class="d-flex justify-content-between mb-2 fw-bold">
