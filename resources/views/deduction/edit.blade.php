        ...
        <form action="{{ route('deduction.update', $deduction) }}" method="post" class="form">
            ...
            <div class="mb-3">
                ...
                <select class="form-select @error('type') is-invalid @enderror" id="type" name="type" required>
                    ...
                    <option value="Fixed" @selected(old('type', $deduction->type) == 'Fixed')>Fixed (Tetap bulanan)</option>
                    <option value="Variable" @selected(old('type', $deduction->type) == 'Variable')>Variable (Berdasarkan hari masuk, dll)</option>
                </select>
